...
> 开场一问的入口: 接到任务先扫本索引, 命中哪个模块就读哪篇 (可多篇)。每篇 = 该模块的连续叙事: 使命与现状 / 决策时间线 / 禁区与已证伪路线 / 关键资产指针 / 未竟事项。维护规则见 AGENTS.md「历史上下文维护」节, 归档用 `/context-archive` skill。

- [berxel-p100r3-native](berxel-p100r3-native.md) — Berxel P100R3 深度相机逆向 / Android UVC 栈重写 / MIX 双流 / 供电与 hub 结论。
