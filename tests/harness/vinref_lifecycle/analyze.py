#!/usr/bin/env python3
"""vinref_lifecycle/analyze.py — M-S8 vin-ref harness 判定器。"""
...
def main(out_dir: str) -> int:
    ...
    must = [
        ...
        "S4.create_batch1",
        "S5.duplicate_name_40201",
        "S6.list_batches",
        "S6b.batches_count",
        "S7.create_sample_A",
        "S8.bulk_samples_10",
        "S9.no_active_yet_zero",
        "S10.publish_batch1",
        "S10b.published_state",
        "S11.write_after_publish_40401",
        "S12.patch_after_publish_40401",
        "S13.active_with_counts",
        "S13b.counts_match",
        "S14.active_samples_A",
        "S14b.samples_A_count",
        "S15.invalid_char_I_10002",
        "S16.publish_batch2",
        "S16b.batch1_auto_archived",
        "S17.active_is_batch2",
        "S18.delete_archived_40401",
        "S19.delete_draft",
        "S20.app_active_samples",
        "S20b.app_path_count",
        "S21.audit_count",
    ]
...
if __name__ == "__main__":
    out = sys.argv[1] if len(sys.argv) > 1 else "/root/lilw/gomob/.dev/vinref_lifecycle"
    sys.exit(main(out))
