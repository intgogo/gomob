#!/usr/bin/env python3
"""cv_engine_smoke/analyze.py — M-S10.1 cv-engine 地基烟测判定器。"""
...
def main(out_dir: str) -> int:
    ...
    must = [
        ...
        "S3b.phase_field",
        "S4.echo_dim_png",
        "S4b.dim_match_48x32x3",
        "S5.echo_dim_jpeg",
        "S5b.dim_match_256x192",
        "S6.echo_dim_garbage_10001",
        "S7.echo_dim_empty_10001",
    ]
...
if __name__ == "__main__":
    out = sys.argv[1] if len(sys.argv) > 1 else "/root/lilw/gomob/.dev/cv_engine_smoke"
    sys.exit(main(out))
