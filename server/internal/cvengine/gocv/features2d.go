...
// Release AKAZE.
func (a *AKAZE) Release() error {
	C.AKAZE_Release((C.AKAZE)(a.p))
	a.p = nil
	return nil
}
...
// Release AgastFeatureDetector.
func (a *AgastFeatureDetector) Release() error {
	C.AgastFeatureDetector_Release((C.AgastFeatureDetector)(a.p))
	a.p = nil
	return nil
}
...
// Release BRISK.
func (b *BRISK) Release() error {
	C.BRISK_Release((C.BRISK)(b.p))
	b.p = nil
	return nil
}
...
// Release FastFeatureDetector.
func (f *FastFeatureDetector) Release() error {
	C.FastFeatureDetector_Release((C.FastFeatureDetector)(f.p))
	f.p = nil
	return nil
}
...
// Release GFTTDetector.
func (a *GFTTDetector) Release() error {
	C.GFTTDetector_Release((C.GFTTDetector)(a.p))
	a.p = nil
	return nil
}
...
// Release KAZE.
func (a *KAZE) Release() error {
	C.KAZE_Release((C.KAZE)(a.p))
	a.p = nil
	return nil
}
...
// Release MSER.
func (a *MSER) Release() error {
	C.MSER_Release((C.MSER)(a.p))
	a.p = nil
	return nil
}
...
// Release ORB.
func (o *ORB) Release() error {
	C.ORB_Release((C.ORB)(o.p))
	o.p = nil
	return nil
}
...
// Release SimpleBlobDetector.
func (b *SimpleBlobDetector) Release() error {
	C.SimpleBlobDetector_Release((C.SimpleBlobDetector)(b.p))
	b.p = nil
	return nil
}
...
// Release BFMatcher
func (b *BFMatcher) Release() error {
	C.BFMatcher_Release((C.BFMatcher)(b.p))
	b.p = nil
	return nil
}
...
func (b *BFMatcher) KnnMatch(query, train Mat, k int) [][]DMatch {
	...
	defer C.MultiDMatches_Release(ret)
